...
st.write('''
    ...
    We are a team of technologists and specialists in international trade. We do the mapping – we do the supply chain. We use cutting edge AI in pursuit of our R&D that aims to push the frontiers of how we perceive intelligent-systems. In what will be an open source dev. sandbox, we will attempt to build life-saver logistics solutions for mystery-box redeemable digital-assets. You will be aiding the transport of essential life-support supplies in a region of political conflict that will be disclosed by admin in further stages.


    #####

    We stand to build supply chain and logistics systems robotized, governed, and robustized to the point where we will be capable of, for lack of better superlatives, 'very' fastidiously transport anything from hash-tokenized-military-assets to sugar. But for now, we do salt.

    We start with the operational expenses we have access to from a group of small tier logistics companies. We start working with tiers of 500+ trucks that comply with standards of transport authorities in the aforementioned region (this allows us to architecture governance easily around vendors and other parties involved).

    **Our vectorized smart-contract calculates your contributions and logs them into the blockchain automating immediate transfer of funds on your technically semi-centralized metamask wallet on a 4-chain confirmation.** 
    
    Contact me at: admin@XXXX for issues with your transfers. We are currently in the process of building a UI that allows you to view the tokens you have earned. Until then, check contribution chart and contact admin. 
    
    **##This project will soon go dark##**
...
st.write('''
    **Top 3 contributors receive $250 + $275 + $330 in goodies/redeemable tokens/ethereum every month.**
    ...
    For the first deliverables, we would require a ui/ux clone of craigslist. The world is a massive mosh-pit of night creatures who’re looking to push the frontiers of what is currently being perceived as intelligence – the foundation to what we are currently architecturing for movement of life-essential-salt across one of the most politically conflicted regions in the world is but 'fingers-crossed-oracled' to become something that will disrupt and bring us closer to the AI God...
